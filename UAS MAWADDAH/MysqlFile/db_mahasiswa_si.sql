...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 11 Des 2023 pada 17.19
...
--
-- Database: `db_mahasiswa_si`
--

-- --------------------------------------------------------

--
-- Struktur dari tabel `data_mhs_si`
--

CREATE TABLE `data_mhs_si` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data untuk tabel `data_mhs_si`
--

INSERT INTO `data_mhs_si` (`id`, `nama`, `nim`, `alamat`, `email`, `tanggal_lahir`, `jenis_kelamin`, `telepon`, `status`, `gambar`) VALUES
(2, 'Lia', '503220062', 'Tanjab', 'lia@gmail.com', '1999-11-12', 'Perempuan', '08226878179', 'Aktif', '657734e4e6098.jpg'),
(3, 'koko', '810771', 'jambi', 'kiki@gmail.com', '2000-12-11', 'Laki-laki', '082792792', 'Aktif', '6577356d23b78.jpg');
...
--
-- Indeks untuk tabel `data_mhs_si`
--
ALTER TABLE `data_mhs_si`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT untuk tabel `data_mhs_si`
--
ALTER TABLE `data_mhs_si`
