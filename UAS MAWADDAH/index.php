...
<head>
  ...
  <body>
    ...
    <div class="container">
      ...
      <h1>Selamat Datang diwebsite Data Mahasiswa Sistem Informasi</h1>
      <h6>UIN Sulthan Thaha Saifuddin Jambi</h6>
      <p>Jurusan Sistem Informasi adalah bidang keilmuan yang 
        menggabungkan ilmu komputer dengan bisnis dan manajemen.
         Di prodi ini kamu akan belajar gimana mengidentifikasi kebutuhan 
         dan proses bisnis perusahaan berdasarkan data-data yang dimiliki perusahan,
          kemudian merancang sistem yang sesuai dengan kebutuhan perusahaan.</p>
        <a href="login.php">
